                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            <div>
                                <Label required htmlFor="project_id">
                                    {t('Project')}
                                </Label>
                                <Select
                            ...
                            <div>
                                <Label required htmlFor="invoice_date">
                                    {t('Invoice Date')}
                                </Label>
                                <Input
                                    id="invoice_date"
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-12 gap-2 mb-1 px-1">
                                <div className="col-span-9">
                                    <Label required className="text-xs">{t('Task')}</Label>
                                </div>
                                <div className="col-span-2">
                                    <Label required className="text-xs text-muted-foreground">{t('Amount')}</Label>
                                </div>
