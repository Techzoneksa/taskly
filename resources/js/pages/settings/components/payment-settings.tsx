    ...
    >
      <form id="payment-settings-form" onSubmit={handleSubmit}>
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className='text-lg font-medium'>{t("Payment Methods")}</CardTitle>
              <CardDescription>
            ...
            <CardContent className="space-y-6">
              ...
              >
                <div className="space-y-2">
                  <Label required={data.is_bank_enabled} htmlFor="bank_detail">{t("Bank Details")}</Label>
                  <Textarea
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <PaymentInputField
                      ...
                      label={t("Public Key")}
                      required={data.is_nepalste_enabled}
              ...
              >
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    />
                    <div className="space-y-2">
                      <Label required htmlFor="paytabs_region">{t("Region")}</Label>
